...
export const GRAPHIC_WORKS: GraphicWork[] = [
  {
    ...
    category: "textile",
    client: "내 작업(개인)",
    thumbnail: "/graphics/sample-textile-01.jpg",
    tags: ["SS 시즌", "플라워", "보헤미안"],
    summary:
  ...
  },
  {
    ...
    category: "tee",
    client: "Sunny & Jade",
    thumbnail: "/graphics/sample-tee-01.jpg",
  ...
  },
  {
    ...
    category: "brand",
    client: "Miogy Studio",
    thumbnail: "/graphics/sample-brand-01.jpg",
    tags: ["로고타입", "브랜딩"],
    summary:
  ...
  },
  {
    ...
    category: "etc",
    client: "개인 컬러 스터디",
    thumbnail: "/graphics/sample-etc-01.jpg",
    tags: ["컬러 팔레트", "무드보드"],
    summary:
